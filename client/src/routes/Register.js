...
export default class Register extends Component{
    ...
    async registerUser(event){
        ...
        let user={userType: this.state.userType, firstName: this.state.firstName, lastName: this.state.lastName, gender: this.state.gender, dob: this.state.dob, emailId: this.state.emailId, password: this.state.password, address: this.state.address, issues: this.state.issues, upload: this.state.upload};
                    ...
                    <div className="card col-md-6 offset-md-3 offset-md-3">
                        <div className="card-body">
                            <form onSubmit={this.registerUser}>
                                <div className="form-group" onChange={this.changeUserTypeHandler}>
                                    <label>Register as:</label>
                                    <input type="radio" value="Member" name="userType"/> Member
                                    <input type="radio" value="Caregiver" name="userType"/> Caregiver
                                    <input type="radio" value="Partner" name="userType"/> Partner
                                    <input type="radio" value="Volunteer" name="userType"/> Volunteer
                                </div>
                                ...
                                <div className="form-group">
                                    <label>Email:</label>
                                    <input placeholder="Email" type="email" name="emailId" className="form-control"
