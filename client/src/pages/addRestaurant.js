...
import { signupPartner } from "../redux/actions/authActions";
...
export default function AddRestaurant() {
	...
	const { loading, serverError, errorsPartner } = useSelector(
		(state) => state.UI
	);

	const { message, errors } = errorsPartner || {};
	...
	const signupPartnerHandle = (props) => {
		...
		formData.append("role", "ROLE_PARTNER");
		dispatch(signupPartner(formData, history));
	};
